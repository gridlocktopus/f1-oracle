"""
Ergast drivers ingestion (raw layer).
...
This module mirrors the style of ergast_calendar.py / ergast_circuits.py,
but targets the drivers endpoint.
"""
...
def ingest_drivers_for_season(
    season: int,
    raw_dir: str | Path = "data/raw",
    client: ErgastClient | None = None,
) -> Path:
    """
    Fetch and store the Ergast drivers snapshot for a season.
    ...
    out_path = out_dir / "drivers.raw.json"
